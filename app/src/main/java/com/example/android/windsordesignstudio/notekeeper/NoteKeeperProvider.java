...
import static com.example.android.windsordesignstudio.notekeeper.NoteKeeperProviderContract.*;
import static com.example.android.windsordesignstudio.notekeeper.database.NoteKeeperDatabaseContract.*;
...
public class NoteKeeperProvider extends ContentProvider {
    ...
    public String getType(Uri uri) {
        ...
        switch(uriMatch){
            case COURSES:
                // vnd.android.cursor.dir/vnd.com.example.android.windsordesignstudio.notekeeper.provider.courses
                // Constants CURSOR_DIR_BASE_TYPE & CURSOR_ITEM_BASE_TYPE are provided by the ContentResolver class
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch(uriMatch) {
            case NOTES:
                ...
                // content://com.example.android.windsordesignstudio.notekeeper.provider/notes/:id
            ...
            case COURSES:
                ...
                break;
            case NOTES_EXPANDED:
                // throw an exception saying this is a read only table
                break;
        }
        return rowUri;
    }
    ...
    public boolean onCreate() {
        ...
        mDbOpenHelper = new NoteKeeperOpenHelper(getContext()); // Cannot use this to get context in a content provider
        return true;
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch(uriMatch) {
            ...
            case NOTES_EXPANDED:
                ...
                break;
            case NOTES_ROW:
                // Specify selection criteria that includes row id value contained in URI
    ...
    private Cursor notesExpandedQuery(SQLiteDatabase db, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        // Table qualify duplicate table columns
